<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserInvestments.aspx.cs" Inherits="Acreageway.UserInvestments" %>
        ...
        <asp:DataList ID="rpt_UserInvestOpportunity" runat="server">
            <HeaderTemplate>
                <table border="1" style="margin: auto auto; padding: 10px;">
                    <tr>
                        ...
                        <th>
                            <asp:Label ID="lbl_th_transactionId" runat="server" Text="Transaction ID" />
                        </th>
                        <td>
                            <asp:Label ID="lbl_transaction_timestamp" runat="server" Text="Transaction Timestamp" />
                        </td>
                        <td>
                            <asp:Label ID="lbl_th_invested_amt" runat="server" Text="Invested Amount" />
                        </td>
                        <th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>$<asp:Label ID="lbl_total_amt" runat="server" Text='<%# Eval("total_amt") %>' />
                    </td>
                    <td>$<asp:Label ID="lbl_amt_left" runat="server" Text='<%# Eval("amt_left") %>' />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="lbl_transaction_id" runat="server" Text='<%# Eval("transaction_id") %>' />
                    </td>
                    <td>
                        <asp:Label ID="lbl_transaction_timestamp" runat="server" Text='<%# Eval("transaction_timestamp") %>' />
                    </td>
                    <td>
                        <asp:Label ID="lbl_invested_amt" runat="server" Text='<%# Eval("invested_amt") %>' />
                    </td>
                    <td>
