<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IssuerManagement.aspx.cs" Inherits="Acreageway.Admin.IssuerManagement" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="lblError" runat="server" Text="" Visible="false"></asp:Label>
    <asp:GridView ID="issuersGrid" runat="server" AllowSorting="True" AllowPaging="True" PageIndex="10" Width="80%" BorderStyle="Solid" EmptyDataText="N/A" BorderWidth="1px" BorderColor="#999999" CellPadding="5" CellSpacing="5" DataKeyNames="id"   
