        ...
        <asp:Repeater ID="rpt_Opportunity" runat="server" OnItemDataBound="rpt_Opportunity_ItemDataBound">
            <HeaderTemplate>
                <table cellspacing="2" border="1">
                    <tr>
                        <th><asp:Label ID="lbl_th_name" runat="server" Text="Name" /></th>
                        <th><asp:Label ID="lbl_th_details" runat="server" Text="Details" /></th>
                        <th><asp:Label ID="lbl_th_crtd" runat="server" Text="Created By" /></th>
                        <th><asp:Label ID="lbl_th_totcap" runat="server" Text="Total Capital" /></th>
                        <th><asp:Label ID="lbl_th_amt" runat="server" Text="Amount To Be Raised" /></th>
                        <th runat="server" id="fav_th"><asp:Label ID="lbl_th_fav" runat="server" Text="Add To Favoutites" /></th>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
