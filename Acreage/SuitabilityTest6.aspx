<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="SuitabilityTest6.aspx.cs" Inherits="Acreage.SuitabilityTest6" %>
...
Spouse or common law partner; Mother or father; Child; Brother, sister, half-brother or half-sister; or Spouse’s or common-law partner’s mother or father."></asp:Label>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_family" ControlToValidate="ddl_family" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_head" ControlToValidate="ddl_head" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_government" ControlToValidate="ddl_government" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_deputy" ControlToValidate="ddl_deputy" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_ambassador" ControlToValidate="ddl_ambassador" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_military" ControlToValidate="ddl_military" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_president" ControlToValidate="ddl_president" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_agency" ControlToValidate="ddl_agency" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_judge" ControlToValidate="ddl_judge" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_leader" ControlToValidate="ddl_leader" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_holder" ControlToValidate="ddl_holder" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_tpd" ControlToValidate="ddl_tpd" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="req_hio" ControlToValidate="ddl_hio" ErrorMessage="* Required" ForeColor="Red" InitialValue="-1" />
